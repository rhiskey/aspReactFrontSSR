...
namespace aspReactTest.Controllers
{
    ...
    [ApiController]
    public class PostedTracksController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var last10Posted = _context.PostedTracks.OrderByDescending(t => t.Date).Take(10);
            return Json(await last10Posted.ToListAsync()); //return View(...);
        }

        // GET: api/PostedTracks/stylecount
        [HttpGet("/stylecount")]
        public async Task<IActionResult> GetStyleCount()
        {
